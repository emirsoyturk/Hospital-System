			...
			<div class="container flex flex-wrap justify-between items-center mx-auto">
				...
				<div class="w-full block w-auto">
					<ul class="flex flex-row space-x-8 p-4 border border-gray-100">
						{ 
							userType !== 'doctor' && userType !== 'patient' && <a href="/" class="block py-2 pr-4 font-semibold pl-3 text-gray-700 text-xl rounded hover:scale-125"> Doctors </a>
						}
						{
							userType !== 'doctor' && userType !== 'patient' && <a href="/" class="block py-2 pr-4 font-semibold pl-3 text-gray-700 text-xl rounded hover:scale-125"> About us </a>
						}
						{
							userType !== 'doctor' && userType !== 'patient' && <a href="/" class="block py-2 pr-4 font-semibold pl-3 text-gray-700 text-xl rounded hover:scale-125"> Contact us </a>
						}
